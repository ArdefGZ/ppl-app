...
<div class="card mt-3">
    <div class="card-content">
        <div class="row row-group m-0">
            ...
            @php
                $totalLulusSkripsi = \App\Models\skripsi::where('status_skripsi', 'lulus')->count();
                $totalLulusPKL = \App\Models\pkl::where('status_pkl', 'lulus')->count();
                $rerataIPK = \App\Models\khs::avg('IP_Kumulatif');
                $totalAktif = \App\Models\mahasiswa::where('status', 'AKTIF')->count();
                $totalTidakAktif = \App\Models\mahasiswa::where('status', 'TIDAK AKTIF')->count();
            @endphp

            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                    <h5 class="text-white mb-0">Jumlah Mahasiswa yang Lulus Skripsi <span class="float-right"><i class="fas fa-graduation-cap"></i></span></h5>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                    <h5 class="text-white mb-0">Jumlah Mahasiswa yang Lulus PKL <span class="float-right"><i class="fas fa-briefcase"></i></span></h5>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                    <h5 class="text-white mb-0">Rerata IPK <span class="float-right"><i class="fas fa-star"></i></span></h5>
                    <p class="mb-0 text-white small-font">{{ number_format($rerataIPK, 2) }}</p>
                </div>
            </div>

            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                    <h5 class="text-white mb-0">Jumlah Mahasiswa Aktif <span class="float-right"><i class="fas fa-check"></i></span></h5>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                    <h5 class="text-white mb-0">Jumlah Mahasiswa Tidak Aktif <span class="float-right"><i class="fas fa-times"></i></span></h5>
