...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const allStudents = {!! json_encode($mahasiswa) !!}; // Convert PHP array to JavaScript array
            ...
            if (studentTable) {
                ...
                results.forEach(student => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${student.NIM}</td>
                        <td>
                            <a href="/dashboard/dosen/${student.NIP}/progress/${student.NIM}">
                                <button type="button" class="btn btn-light px-3">
                                    View
                                </button>
                            </a>
