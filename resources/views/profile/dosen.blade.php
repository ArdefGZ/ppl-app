    ...
    <div class="col-lg-4">
        <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
                ...
                <h5 class="card-title">{{$user->dosen->nama}}</h5>
            ...
            <div class="card-body">
                ...
                <div class="tab-content p-3">
                    ...
                    <div class="tab-pane" id="edit">
                        <form action="/dashboard/dosen/{{$user->NIP}}/profile/edit" method="post">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" type="text" value="{{$user->dosen->nama}}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">NIP <span class="text-danger">Tidak bisa diubah</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" type="text" value="{{$user->dosen->no_HP}}" id="hp" name="hp">
                                </div>
                            </div>
                            <div class="form-group row">
